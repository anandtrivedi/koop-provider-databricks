...
1. [Overview](#overview)
2. [Option 1: Databricks Apps (Recommended)](#option-1-databricks-apps-recommended)
3. [Option 2: Model Serving](#option-2-model-serving)
4. [Testing the Deployment](#testing-the-deployment)
5. [Connecting to ArcGIS Online](#connecting-to-arcgis-online)
...
Example:
```
https://your-workspace.cloud.databricks.com/apps/koop-provider
```
...
**Service-level URL:**
```
https://your-workspace.cloud.databricks.com/apps/koop-provider/databricks/rest/services/main.geospatial.us_cities/FeatureServer
```

**Layer URL:**
```
https://your-workspace.cloud.databricks.com/apps/koop-provider/databricks/rest/services/main.geospatial.us_cities/FeatureServer/0
```

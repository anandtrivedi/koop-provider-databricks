/**
 * Create Test Tables in Databricks Community Edition - geospatial schema
 */
...
async function createTestLayers() {
  ...
  try {
    ...
    console.log('📁 Using geospatial schema...');

    // Drop existing tables
    console.log('\n🗑️  Dropping existing test tables...');
    const tablesToDrop = [
      'geospatial.koop_test_cities',
      'geospatial.koop_test_highways',
      'geospatial.koop_test_states',
      'geospatial.koop_test_parks'
    ];
    ...
    console.log('📊 Summary:');
    console.log('   • geospatial.koop_test_cities: 10 cities');
    console.log('   • geospatial.koop_test_highways: 2 highways');
    console.log('   • geospatial.koop_test_states: 2 states');
    console.log('   • geospatial.koop_test_parks: 3 parks');
    console.log('\n🌐 Test URLs:');
